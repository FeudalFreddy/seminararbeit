\input{einstellungen.tex} % Importiere die Einstellungen
...
% for using generated table by https://www.tablesgenerator.com/#
\usepackage{multirow}
...
\newcommand{\aktuellessemester}{WS 21-22}
...
\include{tex/00_Verzeichnisse}

% Beginn des Inhalts
\pagenumbering{arabic}
\include{tex/01_einleitung}
\include{tex/02_grundlagen}
\include{tex/03_Methode}
\include{tex/04_Ergebnisse}
\include{tex/05_Fazit}
\include{tex/06_anhang}
\include{tex/07_erklaerung}
